  ...
  (
    <div key="artifact-description" className="space-y-2">
      <p>
        ...
        and short writing that show and explain their lives. Students in Germany will do the same, and then we will share our work with each other and
        ...
        people. It will also help them build communication and social skills. This project also shows how
  ...
  (
    <div key="reflection-rationale" className="space-y-4">
      <p>
        ...
        learning experiences. This lesson gives students the chance to observe other people and reflect on similarities
      ...
      <p>
        ...
        resources to connect with teachers around the world who want to do similar activities. I also learned a lot about what goes into planning these kinds of activities. I also had to
