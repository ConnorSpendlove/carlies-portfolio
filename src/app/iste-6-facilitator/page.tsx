  ...
  (
    <div key="artifact-description" className="space-y-2">
      ...
      <p>
        ...
        sounds in single-syllable words, including blends.
      </p>
      <p>
        The lesson includes both an individual learning portion, where students watch a screencast
      ...
      <p>
        I created this artifact to learn how to design a structured lesson using the ASSURE model
  ...
  (
    <div key="reflection-rationale" className="space-y-4">
      ...
      <p>
        ...
        because students are responsible for their own learning during the flipped lesson.
      </p>
      <p>
        In the individual part, students watch a screencast video and practice phonological
      ...
      <p>
        It also connects to 6c: Teach Computational and Design Thinking because students are
