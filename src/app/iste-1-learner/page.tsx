  ...
  (
    <div key="artifact-description" className="space-y-2">
      ...
      <p>
        ...
        resources for elementary literacy instruction and student engagement.
      </p>
      <p>
        I created this artifact so that I can learn about and reflect on research-based teaching
  ...
  (
    <div key="reflection-rationale" className="space-y-4">
      ...
      <p>
        ...
        promising practices that use technology to improve student learning.
      </p>
      <p>
        This assignment helped me see how important it is for teachers to keep growing and not
      ...
      <p>
        Exploring different tools and literacy practices made me want to set goals for myself, such
